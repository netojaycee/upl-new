...
//   const leagueMatchesQueries = useMemo(() => 
//     leagues?.map((league) => useLeagueMatches(league?.id)) || [],
//     [leagues]
//   );
...
//           const leagueMatches = leagueMatchesQueries[i]?.data;
//           if (leagueMatches && Array.isArray(leagueMatches)) {
...
//       setIsMatchesLoading(false);
//     }
//   }, [leagues, leagueMatchesQueries]);

//   // Format date for display
//   const formatDate = (dateValue: any) => {
//     const date =
//       typeof dateValue === "object" && "seconds" in dateValue
//         ? new Date((dateValue as any).seconds * 1000)
//         : new Date(dateValue);
